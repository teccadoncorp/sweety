...
export function WorkLoader({
  ...
  const body = (
    <div className="flex flex-col items-center justify-center gap-2 text-center">
      ...
      <p className="text-xs uppercase tracking-[0.2em] text-violet">{label}</p>
      <div className="h-1 w-36 overflow-hidden rounded-full bg-line">
  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-paper/80 backdrop-blur-sm">{body}</div>
  );
}
